...
export interface ILSP8MintableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeOperator"
      | "balanceOf"
...
export interface ILSP8Mintable extends BaseContract {
  connect(runner?: ContractRunner | null): ILSP8Mintable;
  waitForDeployment(): Promise<this>;

  interface: ILSP8MintableInterface;
