...
export interface BasicLSP8Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeOperator"
      | "balanceOf"
...
export interface BasicLSP8 extends BaseContract {
  connect(runner?: ContractRunner | null): BasicLSP8;
  waitForDeployment(): Promise<this>;

  interface: BasicLSP8Interface;
